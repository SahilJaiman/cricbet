        ...
        <div className="navbar sticky top-0 backdrop-blur-sm z-50 ">
            ...
            <div className="navbar-center  ml-8 hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li>
                        <a href='https://github.com/SahilJaiman/cricbet#how-to-use' className={activeIndex === 2 ? "active cursor-pointer w-36 flex gap-1 text-primary-content" : "w-36 flex gap-1 cursor-pointer"} onClick={() => { setActiveIndex(2); }}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                            How to use
                        </a>
                    </li>
                ...
                <div className="dropdown dropdown-end ">
                    ...
                    <ul tabIndex={0} className="menu menu-sm md:menu-md gap-4 dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className="tooltip tooltip-left" data-tip={account != "" ? account : "Click here to connect!!"}>
                            ...
                            <div className="flex gap-1 justify-between" onClick={onConnectWallet}>
