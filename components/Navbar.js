            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm md:menu-md dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        ...
                        <li>
                            <div href='https://github.com/SahilJaiman/cricbet#how-to-use' className={activeIndex === 2 ? "active text-primary-content flex gap-1" : "flex gap-1"} onClick={() => { setActiveIndex(2); }}>
